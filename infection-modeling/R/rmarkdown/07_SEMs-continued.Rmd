...
paths <- simple_out$coefficients %>% 
  ...
  mutate(
    ...
    # color = case_when(
    #   Std.Estimate >= 0 & P.Value <= 0.5 ~ pos_col,
    #   Std.Estimate >= 0 & P.Value <= 0.1 ~
    #     colorspace::lighten(pos_col, 0.4),
    #   Std.Estimate >= 0 & P.Value > 0.1 ~ 
    #     colorspace::lighten(pos_col, 0.6),
    #   Std.Estimate < 0 & P.Value <= 0.5 ~ neg_col,
    #   Std.Estimate < 0 & P.Value <= 0.1 ~ 
    #     colorspace::lighten(neg_col, 0.4),
    #   Std.Estimate < 0 & P.Value > 0.1 ~ 
    #     colorspace::lighten(neg_col, 0.6),
    #   .default = "grey50"
    # ),
    color = if_else(Std.Estimate >= 0, pos_col, neg_col),
    penwidth = scales::rescale(x = abs(Std.Estimate) ,to = c(0.5, 9)),
